        ...
        <div className="tges_desc">
          ...
          <div>
            <p>
              ...
              website with clear, well-organized navigation which is compatible
              with responsive frameworks. With very precise and easy login
              criteria for parents, employees and for new admissions, it
              provides customized school ERP for 12k+ students and 1k+ teachers.
              It features all the primary requirements such as admission form,
              class section management, teacher management, online fee
              collection etc. An android and IOS button on the top right allows
              each parent to engage with this school closely. It allows them to
              download the mobile app and view their kid’s attendance and
              performance.There is an uncluttered openness to the TGES site
              that, besides looking great, allows it to work well across all
        ...
        <div className="dronstudy_desc">
          ...
          <div>
            <p>
              ...
              and simple interface with features such as Subject courses, Study
              material, Doubt resolution, Test series and Live online tutor. The
              color matching, icons, and pictures on this website are quite
              eye-catching.
            </p>
            <br />
            <p>
      ...
      <div className="greenchoicenow_main">
        ...
        <div className="greenchoicenow_desc">
          ...
          <div>
            ...
            <br />
            <p>
              Stop spending your time analyzing ingredient lists, doing calculus
              on nutrition labels, and Googling claims. Green Choice will curate
              and suggest products based on your personal dietary needs and
              preferences.
            </p>
          </div>
          <div>
        ...
        <div className="bsgforsdg_desc">
          ...
          <div>
            <p>
              ...
              related to SDGs. Be it enhancing your knowledge and understanding
              of the SDGs, reflecting on your daily actions, understanding what
              changes you can make in your everyday life to live sustainably; or
              uploading your own actions on SDGs to empower countless others to
              adapt sustainability as a way of life; - this app can help you do
              all this and so much more.
            </p>
            <br />
            <p>
              The app serves as a platform to help adopt ‘Sustainable Human
              Behaviour’ as a way of life – an essential requirement to achieve
              the SDGs.
            </p>
          </div>
          <div>
      ...
      <div className="elderaid_main">
        ...
        <div className="elderaid_desc">
          ...
          <div>
            ...
            <br />
            <p>
              In keeping with ElderAid’s mission to help elders live life fully,
              our app has been carefully designed and built to ensure maximum
              ease of use for senior citizens, while still being relevant and
              enjoyable to all. Holistic wellness has no age bar, and we are
              here to champion that!
            </p>
          </div>
          <div>
            <Link
